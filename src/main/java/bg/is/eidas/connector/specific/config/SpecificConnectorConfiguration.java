...
public class SpecificConnectorConfiguration implements WebMvcConfigurer {
    ...
    public static PropertySourcesPlaceholderConfigurer properties(
        @Value("#{environment.SPECIFIC_CONNECTOR_CONFIG_REPOSITORY}/specificCommunicationDefinitionConnector.xml") String specificCommunicationConfig,
        @Value("#{environment.EIDAS_CONFIG_REPOSITORY}/eidas.xml") String eidasConfig,
        @Value("#{environment.SPECIFIC_CONNECTOR_CONFIG_REPOSITORY}/application.properties") String applicationProperties
        ...
        Assert.isTrue(new File(applicationProperties).exists(), "Required configuration file not found: " + applicationProperties);
        PropertySourcesPlaceholderConfigurer ppc = new PropertySourcesPlaceholderConfigurer();
        ppc.setLocations(
            new FileUrlResource(specificCommunicationConfig),
            new FileUrlResource(eidasConfig),
            new FileUrlResource(applicationProperties)
        );
