...
import bg.is.eidas.connector.specific.config.SpecificConnectorProperties.ServiceProvider;
import bg.is.eidas.connector.specific.exception.CertificateResolverException;
import bg.is.eidas.connector.specific.exception.SpecificConnectorException;
