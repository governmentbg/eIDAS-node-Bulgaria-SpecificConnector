...
import bg.is.eidas.connector.specific.config.SpecificConnectorProperties.SigningMethod;
import bg.is.eidas.connector.specific.integration.EidasNodeCommunication;
import bg.is.eidas.connector.specific.integration.SpecificConnectorCommunication;
import bg.is.eidas.connector.specific.responder.saml.OpenSAMLUtils;
import com.fasterxml.jackson.databind.JsonNode;
import bg.is.eidas.connector.specific.exception.AuthenticationException;
import bg.is.eidas.connector.specific.exception.BadRequestException;
import bg.is.eidas.connector.specific.exception.CertificateResolverException;
import bg.is.eidas.connector.specific.responder.serviceprovider.LightRequestFactory;
import bg.is.eidas.connector.specific.responder.serviceprovider.ResponseFactory;
import bg.is.eidas.connector.specific.responder.serviceprovider.ServiceProviderMetadata;
import bg.is.eidas.connector.specific.responder.serviceprovider.ServiceProviderMetadataRegistry;
...
import static bg.is.eidas.connector.specific.exception.ResponseStatus.SP_SIGNING_CERT_MISSING_OR_INVALID;
import static bg.is.eidas.connector.specific.responder.serviceprovider.LightRequestFactory.REQUESTED_ATTRIBUTES_QNAME;
import static bg.is.eidas.connector.specific.responder.serviceprovider.LightRequestFactory.REQUESTER_ID_QNAME;
import static bg.is.eidas.connector.specific.responder.serviceprovider.LightRequestFactory.SPTYPE_QNAME;
